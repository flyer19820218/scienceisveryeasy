...
if selected_season == "第一季：化學大聯盟 ⚾":
    ...
    # 🌟 NEW! 第七集：最新上架，預設展開 🌟
    with st.expander("🔥 EP07 | 超音速跑壘測試賽！雙重爆發與反應速率", expanded=True):
        ...
        # 播放器 (真實音檔路徑)
        st.audio("audio/第一季_化學大聯盟_第7集_超音速跑者與雙重爆發_速率現象版.mp3", format="audio/mp3")
    ...
    with st.expander("🌟 EP06 | 球場的五大無名英雄與石灰三兄弟變身大秀", expanded=False):
        ...
        st.audio("audio/第一季_化學大聯盟_第6集_球場的五大無名英雄_快樂學習版.mp3", format="audio/mp3")
    ...
    with st.expander("🌟 EP05 | 五局下半的極限拆彈任務！世紀大決戰與酸鹼中和", expanded=False):
        ...
        st.audio("audio/第一季_化學大聯盟_第5集_極限拆彈_無語助詞強化版.mp3", format="audio/mp3")
